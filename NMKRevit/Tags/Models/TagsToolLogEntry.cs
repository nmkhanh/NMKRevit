...
{
  public sealed class TagsToolLogEntry
  {
    ...
    public TagsToolLogEntry(TagsToolLogLevel level, string tool, string elementId, string message)
    {
      Time = DateTime.Now;
      Level = level;
      Tool = tool;
    ...
    {
      TagsToolLogLevel.Success => SuccessBrush,
      TagsToolLogLevel.Warning => WarningBrush,
      TagsToolLogLevel.Error => ErrorBrush,
      _ => InfoBrush
    };
